...
func (*Name) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{0}
}
...
func (*OrderCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{1}
}
...
func (*Project) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{2}
}
...
func (*ProjectOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{3}
}
...
func (*Merchant) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{4}
}
...
type Order struct {
	...
	PaymentMethodIncomeCurrencyA3 string `protobuf:"bytes,19,opt,name=payment_method_income_currency_a3,json=paymentMethodIncomeCurrencyA3,proto3" json:"-" bson:"-" structure:"-"`
	// @inject_tag: bson:"pm_order_close_date" structure:"pm_order_close_date,timestamp"
	PaymentMethodOrderClosedAt *timestamp.Timestamp `protobuf:"bytes,20,opt,name=payment_method_order_closed_at,json=paymentMethodOrderClosedAt,proto3" json:"payment_method_order_closed_at,omitempty" bson:"pm_order_close_date" structure:"pm_order_close_date,timestamp"`
	// @inject_tag: bson:"status" structure:"status"
	Status int32 `protobuf:"varint,21,opt,name=status,proto3" json:"status,omitempty" bson:"status" structure:"status"`
	// @inject_tag: bson:"created_at" structure:"created_at,timestamp"
	CreatedAt *timestamp.Timestamp `protobuf:"bytes,22,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty" bson:"created_at" structure:"created_at,timestamp"`
	// @inject_tag: bson:"updated_at" structure:"updated_at,timestamp"
	UpdatedAt *timestamp.Timestamp `protobuf:"bytes,23,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty" bson:"updated_at" structure:"updated_at,timestamp"`
	// @inject_tag: bson:"created_by_json" structure:"created_by_json"
	IsJsonRequest bool `protobuf:"varint,24,opt,name=is_json_request,json=isJsonRequest,proto3" json:"is_json_request,omitempty" bson:"created_by_json" structure:"created_by_json"`
	// @inject_tag: bson:"amount_psp_ac" structure:"amount_psp_ac"
	AmountInPspAccountingCurrency float64 `protobuf:"fixed64,25,opt,name=amount_in_psp_accounting_currency,json=amountInPspAccountingCurrency,proto3" json:"amount_in_psp_accounting_currency,omitempty" bson:"amount_psp_ac" structure:"amount_psp_ac"`
	// @inject_tag: bson:"amount_in_merchant_ac" structure:"amount_in_merchant_ac"
	AmountInMerchantAccountingCurrency float64 `protobuf:"fixed64,26,opt,name=amount_in_merchant_accounting_currency,json=amountInMerchantAccountingCurrency,proto3" json:"amount_in_merchant_accounting_currency,omitempty" bson:"amount_in_merchant_ac" structure:"amount_in_merchant_ac"`
	// @inject_tag: bson:"amount_out_merchant_ac" structure:"amount_out_merchant_ac"
	AmountOutMerchantAccountingCurrency float64 `protobuf:"fixed64,27,opt,name=amount_out_merchant_accounting_currency,json=amountOutMerchantAccountingCurrency,proto3" json:"amount_out_merchant_accounting_currency,omitempty" bson:"amount_out_merchant_ac" structure:"amount_out_merchant_ac"`
	// @inject_tag: bson:"amount_ps_ac" structure:"amount_ps_ac"
	AmountInPaymentSystemAccountingCurrency float64 `protobuf:"fixed64,28,opt,name=amount_in_payment_system_accounting_currency,json=amountInPaymentSystemAccountingCurrency,proto3" json:"amount_in_payment_system_accounting_currency,omitempty" bson:"amount_ps_ac" structure:"amount_ps_ac"`
	// @inject_tag: bson:"pm_account" structure:"pm_account"
	PaymentMethodPayerAccount string `protobuf:"bytes,29,opt,name=payment_method_payer_account,json=paymentMethodPayerAccount,proto3" json:"payment_method_payer_account,omitempty" bson:"pm_account" structure:"pm_account"`
	// @inject_tag: bson:"pm_txn_params" structure:"pm_txn_params"
	PaymentMethodTxnParams map[string]string `protobuf:"bytes,30,rep,name=payment_method_txn_params,json=paymentMethodTxnParams,proto3" json:"payment_method_txn_params,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"pm_txn_params" structure:"pm_txn_params"`
	// @inject_tag: bson:"fixed_package" structure:"fixed_package"
	FixedPackage *FixedPackage `protobuf:"bytes,31,opt,name=fixed_package,json=fixedPackage,proto3" json:"fixed_package,omitempty" bson:"fixed_package" structure:"fixed_package"`
	// @inject_tag: bson:"payment_requisites" json:"-" structure:"payment_requisites"
	PaymentRequisites map[string]string `protobuf:"bytes,32,rep,name=payment_requisites,json=paymentRequisites,proto3" json:"-" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"payment_requisites" structure:"payment_requisites"`
	// @inject_tag: bson:"psp_fee_amount" structure:"psp_fee_amount"
	PspFeeAmount *OrderFeePsp `protobuf:"bytes,33,opt,name=psp_fee_amount,json=pspFeeAmount,proto3" json:"psp_fee_amount,omitempty" bson:"psp_fee_amount" structure:"psp_fee_amount"`
	// @inject_tag: bson:"project_fee_amount" structure:"project_fee_amount"
	ProjectFeeAmount *OrderFee `protobuf:"bytes,34,opt,name=project_fee_amount,json=projectFeeAmount,proto3" json:"project_fee_amount,omitempty" bson:"project_fee_amount" structure:"project_fee_amount"`
	// @inject_tag: bson:"to_payer_fee_amount" structure:"to_payer_fee_amount"
	ToPayerFeeAmount *OrderFee `protobuf:"bytes,35,opt,name=to_payer_fee_amount,json=toPayerFeeAmount,proto3" json:"to_payer_fee_amount,omitempty" bson:"to_payer_fee_amount" structure:"to_payer_fee_amount"`
	// @inject_tag: bson:"vat_amount" structure:"vat_amount"
	VatAmount float64 `protobuf:"fixed64,36,opt,name=vat_amount,json=vatAmount,proto3" json:"vat_amount,omitempty" bson:"vat_amount" structure:"vat_amount"`
	// @inject_tag: bson:"ps_fee_amount" structure:"ps_fee_amount"
	PaymentSystemFeeAmount *OrderFeePaymentSystem `protobuf:"bytes,37,opt,name=payment_system_fee_amount,json=paymentSystemFeeAmount,proto3" json:"payment_system_fee_amount,omitempty" bson:"ps_fee_amount" structure:"ps_fee_amount"`
	XXX_NoUnkeyedLiteral   struct{}               `json:"-" bson:"-" structure:"-"`
	XXX_unrecognized       []byte                 `json:"-" bson:"-" structure:"-"`
	XXX_sizecache          int32                  `json:"-" bson:"-" structure:"-"`
}
...
func (*Order) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{5}
}
...
func (*Currency) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{6}
}
...
func (*PayerData) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{7}
}
...
func (*PaymentMethodOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{8}
}
...
func (*PaymentMethodParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{9}
}
...
func (*PaymentSystem) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{10}
}
...
func (*FixedPackage) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{11}
}
...
func (*FixedPackages) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{12}
}
...
func (*OrderFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{13}
}
...
func (*OrderFeePsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{14}
}
...
func (*OrderFeePaymentSystem) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{15}
}
...
func (*ProjectPaymentMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{16}
}
...
func (*CurrencyRate) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{17}
}
...
func (*PaymentMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{18}
}
...
func (*Country) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{19}
}
...
func (*Vat) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{20}
}
...
func (*Commission) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{21}
}
...
func (*CardExpire) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{22}
}
...
func (*SavedCard) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{23}
}
...
func (*PaymentFormPaymentMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_billing_16f86d34e53f606b, []int{24}
}
...
func init() { proto.RegisterFile("billing/billing.proto", fileDescriptor_billing_16f86d34e53f606b) }

var fileDescriptor_billing_16f86d34e53f606b = []byte{
	...
	,
}
