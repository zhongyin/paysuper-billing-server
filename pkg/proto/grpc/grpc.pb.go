...
func (*EmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{0}
}
...
func (*EmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{1}
}
...
func (*PaymentCreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{2}
}
...
func (*PaymentCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{3}
}
...
func (*PaymentFormJsonDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{4}
}
...
func (*PaymentFormJsonDataProject) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{5}
}
...
func (*PaymentFormJsonDataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{6}
}
...
func (*PaymentNotifyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{7}
}
...
func (*PaymentNotifyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{8}
}
...
func (*ConvertRateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{9}
}
...
func (*ConvertRateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{10}
}
...
type OnboardingBanking struct {
	// @inject_tag: validate:"required,len=3" json:"currency"
	Currency string `protobuf:"bytes,1,opt,name=currency,proto3" json:"currency" validate:"required,len=3"`
	// @inject_tag: validate:"required" json:"name"
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name" validate:"required"`
	// @inject_tag: validate:"required" json:"address"
	Address string `protobuf:"bytes,3,opt,name=address,proto3" json:"address" validate:"required"`
	// @inject_tag: validate:"required" json:"account_number"
	AccountNumber string `protobuf:"bytes,4,opt,name=account_number,json=accountNumber,proto3" json:"account_number" validate:"required"`
	// @inject_tag: validate:"required" json:"swift"
	Swift string `protobuf:"bytes,5,opt,name=swift,proto3" json:"swift" validate:"required"`
	// @inject_tag: validate:"required" json:"details"
	Details              string   `protobuf:"bytes,6,opt,name=details,proto3" json:"details" validate:"required"`
	XXX_NoUnkeyedLiteral struct{} `json:"-" bson:"-" structure:"-" validate:"-"`
	XXX_unrecognized     []byte   `json:"-" bson:"-" structure:"-" validate:"-"`
	XXX_sizecache        int32    `json:"-" bson:"-" structure:"-" validate:"-"`
}
...
func (*OnboardingBanking) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{11}
}
...
type OnboardingRequest struct {
	...
	// @inject_tag: validate:"required" json:"alternative_name"
	AlternativeName string `protobuf:"bytes,4,opt,name=alternative_name,json=alternativeName,proto3" json:"alternative_name" validate:"required"`
	// @inject_tag: validate:"required" json:"website"
	Website string `protobuf:"bytes,5,opt,name=website,proto3" json:"website" validate:"required"`
	// @inject_tag: validate:"required,len=2" json:"country"
	Country string `protobuf:"bytes,6,opt,name=country,proto3" json:"country" validate:"required,len=2"`
	// @inject_tag: validate:"required" json:"state"
	State string `protobuf:"bytes,7,opt,name=state,proto3" json:"state" validate:"required"`
	// @inject_tag: validate:"required" json:"zip"
	Zip string `protobuf:"bytes,8,opt,name=zip,proto3" json:"zip" validate:"required"`
	// @inject_tag: validate:"required" json:"city"
	City string `protobuf:"bytes,9,opt,name=city,proto3" json:"city" validate:"required"`
	// @inject_tag: validate:"required" json:"address"
	Address string `protobuf:"bytes,10,opt,name=address,proto3" json:"address" validate:"required"`
	// @inject_tag: validate:"required" json:"address_additional"
	AddressAdditional string `protobuf:"bytes,11,opt,name=address_additional,json=addressAdditional,proto3" json:"address_additional" validate:"required"`
	// @inject_tag: validate:"required" json:"registration_number"
	RegistrationNumber string `protobuf:"bytes,12,opt,name=registration_number,json=registrationNumber,proto3" json:"registration_number" validate:"required"`
	// @inject_tag: validate:"required" json:"tax_id"
	TaxId string `protobuf:"bytes,13,opt,name=tax_id,json=taxId,proto3" json:"tax_id" validate:"required"`
	// @inject_tag: validate:"required,dive" json:"contacts"
	Contacts *billing.MerchantContact `protobuf:"bytes,14,opt,name=contacts,proto3" json:"contacts" validate:"required,dive"`
	// @inject_tag: validate:"required,dive" json:"banking"
	Banking              *OnboardingBanking `protobuf:"bytes,15,opt,name=banking,proto3" json:"banking" validate:"required,dive"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-" bson:"-" structure:"-" validate:"-"`
	XXX_unrecognized     []byte             `json:"-" bson:"-" structure:"-" validate:"-"`
	XXX_sizecache        int32              `json:"-" bson:"-" structure:"-" validate:"-"`
}
...
func (*OnboardingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{12}
}
...
func (*FindByIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{13}
}
...
func (*MerchantListingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{14}
}
...
func (*Merchants) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{15}
}
...
func (*MerchantChangeStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{16}
}
...
func (*NotificationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{17}
}
...
func (*Notifications) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{18}
}
...
func (*ListingNotificationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{19}
}
...
func (*ListingMerchantPaymentMethod) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{20}
}
...
func (*GetMerchantPaymentMethodRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{21}
}
...
func (*ListMerchantPaymentMethodsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{22}
}
...
func (*MerchantPaymentMethodRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{23}
}
...
func (*MerchantPaymentMethodResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_36bc67fe429c760c, []int{24}
}
...
func init() { proto.RegisterFile("grpc/grpc.proto", fileDescriptor_grpc_36bc67fe429c760c) }

var fileDescriptor_grpc_36bc67fe429c760c = []byte{
	...
	,
}
